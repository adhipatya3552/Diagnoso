...
import { X, Download, ZoomIn, ZoomOut, RotateCw as RotateClockwise, ChevronLeft, ChevronRight, Maximize, Minimize, Eye } from 'lucide-react';
...
export const FilePreview: React.FC<FilePreviewProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/50 backdrop-blur-sm rounded-full p-2 flex items-center space-x-2">
              ...
              <button
                ...
                title="Rotate"
              >
                <RotateClockwise className="w-5 h-5" />
              </button>
            </div>
          </div>
        ) : isPdf ? (
      ...
      {/* Navigation arrows for image galleries (future feature) */}
      {isImage && (
        <>
          <button
